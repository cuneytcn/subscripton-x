  ...
  return (
    <motion.div
      ...
      <div className='mb-12 text-center'>
        <h1 className='mb-4 text-4xl font-bold md:text-5xl'>İletişime Geçin</h1>
        <p className='mx-auto max-w-2xl text-xl text-gray-600'>
          Projeniz için ücretsiz danışmanlık alın. En kısa sürede size dönüş
          yapalım.
        </p>
      </div>
        ...
        {contact?.contactInfo?.map((item) => (
          <motion.a
            ...
            <div className='mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-xl bg-primary-50 text-primary-600 transition-colors group-hover:bg-primary-600 group-hover:text-white'>
              ...
              {item.icon === 'MapPin' && <MapPin className='h-6 w-6' />}
            </div>
